...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.cc1.setText(_translate("Form", "Archer"))
        self.cc2.setText(_translate("Form", "Knight"))
        self.play.setText(_translate("Form", "Play"))
        # self.c3.setText(_translate("Form", "TextLabel"))
        # self.c4.setText(_translate("Form", "TextLabel"))
        self.cc3.setText(_translate("Form", "Magician"))
        self.cc4.setText(_translate("Form", "Assassin"))
