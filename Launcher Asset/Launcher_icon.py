...
class Ui_Main_Window(object):
    def setupUi(self, Main_Window):
        ...
        self.Play_Button.setGeometry(QRect(510, 390, 201, 101))
        font1 = QFont()
        ...
        self.buttonBox.setGeometry(QRect(310, 80, 156, 23))
        self.buttonBox.setStandardButtons(QDialogButtonBox.Reset|QDialogButtonBox.Save)
        self.label = QLabel(self.Graphics_Settings)
        self.label.setObjectName(u"label")
        self.label.setGeometry(QRect(20, 80, 47, 21))
        self.radioButton_On = QRadioButton(self.Graphics_Settings)
        self.radioButton_On.setObjectName(u"radioButton_On")
        self.radioButton_On.setGeometry(QRect(70, 80, 83, 21))
        self.radioButton_Off = QRadioButton(self.Graphics_Settings)
        self.radioButton_Off.setObjectName(u"radioButton_Off")
        self.radioButton_Off.setGeometry(QRect(130, 80, 83, 21))
    ...
    def retranslateUi(self, Main_Window):
        ...
        self.label.setText(QCoreApplication.translate("Main_Window", u"Music", None))
        self.radioButton_On.setText(QCoreApplication.translate("Main_Window", u"On", None))
        self.radioButton_Off.setText(QCoreApplication.translate("Main_Window", u"Off", None))
    # retranslateUi
